...
//
// BONUS 2:
// Create a student roster management app. Using the user dialogue functions (alert, confirm, prompt), create
// an application that will prompt the user to choose from a menu with the following actions:
